...
function Checkbox({
  ...
  // A "some but not all" checkbox has to look different from a checked one, or a
  // parent row claims its whole subtree is selected when it isn't. Read off the
  // controlled prop: an uncontrolled checkbox can never be indeterminate.
